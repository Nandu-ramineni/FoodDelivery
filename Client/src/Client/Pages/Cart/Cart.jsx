				...
				<div className='w-full lg:w-1/2'>
					...
					<div className='border border-gray-300 rounded-lg p-4 mb-6'>
						<p className='text-gray-700'>
							Lingampalli Railway Station, Lingampalli, Hyderabad, 500019, Rail
							Vihar, Serilingampally, Hyderabad, Telangana 500133, India
						</p>
					...
					<div className='border border-gray-300 rounded-lg p-4 mb-6'>
						<button
							...
							{loading ? <p>Loading..</p> : 'Proceed To Pay'}
						</button>
					</div>
				</div>
							...
							cartItems.map((item) => (
								<div
									...
									<div className='flex items-center'>
										...
										/>
										<div className='ml-4'>
											<h3 className='lg:text-lg font-semibold md:text-md sm:truncate'>
												{item.productName}
											</h3>
											...
											<div className='flex items-center'>
												<button
													...
													className='bg-gray-300 text-md px-1 '>
													-
												</button>
							...
							<div className='mt-8'>
								...
								<div className='flex items-center mb-6'>
									...
									<button
										...
										className='bg-[#8EC44C] hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-r-lg'>
										APPLY
									</button>
								</div>
							</div>
